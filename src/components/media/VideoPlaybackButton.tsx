...
export function VideoPlaybackButton({ className = "" }: VideoPlaybackButtonProps) {
  ...
  return (
    ...
    >
      {isPaused ? (
        <svg aria-hidden="true" className="h-[31px] w-[38px]" viewBox="0 0 36 46" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M0 0V45.2136L35.525 22.6068L0 0Z" fill="currentColor" />
        </svg>
      ) : (
        <svg aria-hidden="true" className="h-[31px] w-[38px]" viewBox="0 0 34 46" fill="none" xmlns="http://www.w3.org/2000/svg">
