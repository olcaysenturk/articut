  ...
  return (
    <LegalPageLayout title={<>Terms<br className="hidden md:block" /> &amp; Conditions</>} long>
      ...
      <LegalSection title="SECTION 5 - PRODUCTS OR SERVICES (if applicable)">
        <p>Certain products or Services may be available exclusively online through the website. These products or Services may have limited quantities and are subject to return or exchange only according to our <Link href="/returns" className="underline">Refund Policy</Link>.</p>
      ...
      <LegalSection title="SECTION 10 - PERSONAL INFORMATION">
        <p>Your submission of personal information through the store is governed by our <Link href="/privacy" className="underline">Privacy Policy</Link>.</p>
      </LegalSection>
