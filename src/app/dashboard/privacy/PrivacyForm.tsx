...
export function PrivacyForm({
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    formData.append("privacy-updated", updated);
  ...
  return (
    <div className="grid grid-cols-[200px_1fr] gap-6">
      ...
      <form id="privacy-form" onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="rounded-lg border border-[#d0d0d0] bg-white p-6">
          <label className="block text-sm max-w-xs">
            <span className="font-medium text-[#1f1f1f]">Last updated date</span>
            <input
              type="text"
              placeholder="e.g., 02.13.26"
              value={updated}
                  ...
                  <div className="border-t border-[#e0e0e0] px-6 py-4 space-y-4">
                    ...
                    <label className="block text-sm">
                      <span className="font-medium text-[#1f1f1f]">
                        Content (leave a blank line between paragraphs; start a line with &quot;- &quot; for a bullet list)
                      </span>
                      <textarea
