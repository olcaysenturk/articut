...
export const MOBILE_CUTPILOT_FEATURE_CONFIG: FeatureSectionConfig = {
  ...
  sectionClassName:
    "absolute left-0 top-[620px] h-[580px] w-full overflow-hidden bg-black text-white",
  ...
  sequence: {
    ...
    startAt: 1.5,
    duration: 6,
    canvasClassName: "absolute inset-0 z-0 h-full w-full origin-center -translate-y-[5px] scale-[1.03] object-cover",
  },
  features: FEATURES,
  featuresClassName:
...
export const MOBILE_CUTSCISSORS_FEATURE_CONFIG: FeatureSectionConfig = {
  ...
  headingClassName:
    "mobile-feature-heading absolute left-1/2 top-[40px] z-10 w-[calc(100%-64px)] max-w-[329px] -translate-x-1/2",
  sectionClassName:
    "absolute left-0 top-[2199px] h-[580px] w-full overflow-hidden bg-[#e04d26] text-white",
  backgroundImage: {
    src: "/figma/scissors-hero.png",
    alt: "Articut scissors",
    fill: true,
